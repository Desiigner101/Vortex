...
public class UmbraFinalBoss implements EnemyClass {
    // Stats
    private int HP = 5000;
    ...
    // Animation
    private final String idleAnimationPath = "Enemies/UmbraFinalBoss.png";
    ...
    private void loadAnimations() {
        Texture idleSheet = new Texture(Gdx.files.internal("Enemies/UmbraFinalBoss.png"));
        TextureRegion[][] frames = TextureRegion.split(idleSheet,
            idleSheet.getWidth()/10, // 15 frames wide
            idleSheet.getHeight());
