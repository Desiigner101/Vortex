...
public class VoidSentinel implements EnemyClass {
    // Stats
    private int HP = 3000;
    private int maxHP = 3000;
    private int Atk = 200 ;
    private String name = "Void Sentinel";
    private boolean isBoss = true;
    // Animation
    private final String idleAnimationPath = "Enemies/VoidSentinel.png";
    ...
    private void loadAnimations() {
        Texture idleSheet = new Texture(Gdx.files.internal("Enemies/VoidSentinel.png"));
